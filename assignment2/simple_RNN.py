  ...
  def forward(self, inputs, hidden):
    ...
    for i in range(self.seq_len):
        ...
        for l in range(self.num_layers):
            ...
            h_fc = self.activation(self.dropout[0](self.fc[l](h_recurrent)))
            # Initialize next layers inputs
            h_previous_ts[l] = h_recurrent
            h_previous_layer = h_fc
        logits.append(self.decode(h_fc))
